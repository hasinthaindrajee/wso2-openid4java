...
<div id="wrapper">
    <div id="header">
        <img src="<c:out value='${pageContext.request.contextPath}'/>/images/openid_information_cards_demo.png"
             alt="logo" title=""/>
    </div>
        ...
        <div class="form">
            ...
            <form name="openid-login" action="<c:out value='${pageContext.request.contextPath}'/>/" method="post">
                <table>
                    <tr>
                        <td>
                            <input type="text" name="openid_identifier" value="<c:out value='${openid_identifier}'/>"
                                   class="openid"/>
                        </td>
                        <td>
            ...
            <form name='infocard' method='post' action="<c:out value='${pageContext.request.contextPath}'/>/"
                ...
                <OBJECT type="application/x-informationCard" name="xmlToken">
                    ...
                    <param name="optionalClaims"
                           Value="http://axschema.org/contact/email http://axschema.org/namePerson/first http://axschema.org/namePerson/last http://axschema.org/contact/phone/default http://axschema.org/contact/postalAddress/home http://axschema.org/contact/city/home http://axschema.org/contact/postalCode/home http://axschema.org/contact/country/home http://axschema.org/contact/web/blog">
                </OBJECT>
            </form>

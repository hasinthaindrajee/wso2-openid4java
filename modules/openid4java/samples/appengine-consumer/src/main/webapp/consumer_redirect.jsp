<%@ page session="true" %>
<%@ page
        import="org.openid4java.OpenIDException,org.openid4java.consumer.ConsumerManager,org.openid4java.discovery.DiscoveryException, org.openid4java.discovery.DiscoveryInformation, org.openid4java.message.AuthRequest, java.util.Iterator, java.util.List,  java.util.Map" %>
